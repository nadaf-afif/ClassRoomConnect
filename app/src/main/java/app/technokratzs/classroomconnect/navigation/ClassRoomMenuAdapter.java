 ...
 */
public class ClassRoomMenuAdapter extends RecyclerView.Adapter<ClassRoomMenuAdapter.MyViewHolder>{

    private LayoutInflater mInflater;
    List<RecyclerData> data = Collections.emptyList();
    private ClickListener mClickListener;

    public ClassRoomMenuAdapter(Context context, List<RecyclerData> data) {
